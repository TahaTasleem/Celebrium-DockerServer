...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", type=str, required=False, default="https://api.cortex.cerebrium.ai/v4/p-b09172cb/celebrium-docker-prod/predict/", help="Deployed model endpoint URL")
